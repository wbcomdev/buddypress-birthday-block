...
/***/ "./src/data/fetchProfileFields.js":
/*!****************************************!*\
  !*** ./src/data/fetchProfileFields.js ***!
  \****************************************/
...
const fetchProfileFields = async () => {
  try {
    const fields = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0___default()({
...
function Members(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)(), members.length > 0 ? members.map(member => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    href: member.link
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, member.name))))) : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('No members Found', 'buddypress-birthday')));
}
...
/* harmony import */ var _data_fetchProfileFields__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./data/fetchProfileFields */ "./src/data/fetchProfileFields.js");
...
function Edit(_ref) {
  ...
  const [profileFields, setProfileFields] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)([]);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    // Fetch profile fields from the external file
    (0,_data_fetchProfileFields__WEBPACK_IMPORTED_MODULE_5__.fetchProfileFields)().then(fields => {
  ...
  })))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_data_members__WEBPACK_IMPORTED_MODULE_4__["default"], attributes));
}
